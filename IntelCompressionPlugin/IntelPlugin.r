...
#define plugInName			TEXExporterPluginName
#define plugInCopyrightYear	"2015"
#define plugInDescription \
	"A DDS/Tex Export plug-in for Adobe Photoshop."
...
#define vendorName				TEXExporterPluginName
#define plugInAETEComment		"history export plug-in"

#define plugInSuiteID			'sdK6'
...
resource 'aete' (ResourceID, plugInName " dictionary", purgeable)
{
	1, 0, english, roman,									/* aete version and language specifiers */
	{
		...
		TEXExporterPluginName,	    	  		            /* optional description */
